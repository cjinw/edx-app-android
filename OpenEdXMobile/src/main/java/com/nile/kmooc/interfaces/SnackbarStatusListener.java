...
public interface SnackbarStatusListener {
     ...
     * visibility of {@link com.nile.kmooc.http.notifications.FullScreenErrorNotification FullScreenErrorNotification}.
     * <br/>
     * Note: At one time only one type of error i.e. either SnackBar or Full Screen error should be
     * visible on screen.
     *
     * @param fullScreenErrorVisibility Visibility of {@link com.nile.kmooc.http.notifications.FullScreenErrorNotification FullScreenErrorNotification}.
     */
