...
import com.nile.kmooc.util.ConfigUtil;
import com.nile.kmooc.util.NetworkUtil;
import com.nile.kmooc.util.StandardCharsets;
import com.nile.kmooc.util.links.EdxCourseInfoLink;
import com.nile.kmooc.util.links.EdxEnrollLink;
...
public class URLInterceptorWebViewClient extends WebViewClient {
     ...
     * of actions as declared in {@link com.nile.kmooc.view.custom.URLInterceptorWebViewClient.IActionListener}.
     *
     ...
     * calls {@link com.nile.kmooc.view.custom.URLInterceptorWebViewClient.IActionListener#onClickCourseInfo(String)}
     *
     ...
     * calls {@link com.nile.kmooc.view.custom.URLInterceptorWebViewClient.IActionListener#onClickEnroll(String, boolean)}
     *
