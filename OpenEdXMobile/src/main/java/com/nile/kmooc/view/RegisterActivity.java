...
import com.nile.kmooc.module.registration.view.RegistrationEditTextView;
import com.nile.kmooc.module.registration.view.RegistrationSelectView;
...
public class RegisterActivity extends BaseFragmentActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        agreementMessageView.setText(com.nile.kmooc.util.TextUtils.generateLicenseText(getResources(), R.string.by_creating_account));
